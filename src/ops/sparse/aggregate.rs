    ...
    DType: FromPrimitive,
{
    ...
    pub fn _reduce_log_sum_exp_sparse(
        &self,
        shape: &Vec<usize>,
        indices: &Tensor<u32>,
        axes: &Vec<usize>,
    ...
    pub fn reduce_log_sum_exp_sparse(
        &self,
        shape: Uint32Array,
        indices: &Tensor<u32>,
        axes: Uint32Array,
        ...
        self._reduce_log_sum_exp_sparse(&_shape, indices, &_axes, keep_dims)
    }
}
