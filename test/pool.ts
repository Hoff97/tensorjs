...
export default function testPool(name: string, constructor: TensorConstructor, wait?: Promise<void>) {
  describe(`${name} sum`, () => {
    ...
    it('should compute the column wise sum with axes=0', async () => {
      ...
      expect(await a.sum(0).compare(expected, DELTA)).toBeTruthy();
    });
    ...
    it('should compute the row wise sum with axes=1', async () => {
      ...
      expect(await a.sum(1).compare(expected, DELTA)).toBeTruthy();
    });
  ...
  describe(`${name} product`, () => {
    ...
    it('should compute the column wise product with axes=0', async () => {
      ...
      const a = constructor([2, 3], [1, 2, 3, 4, 5, 6]);
      const expected = constructor([3], [4, 10, 18]);

      expect(await a.product(0).compare(expected, DELTA)).toBeTruthy();
    });
    ...
    it('should compute the row wise product with axes=1', async () => {
      ...
      const a = constructor([2, 3], [1, 2, 3, 4, 5, 6]);
      const expected = constructor([2], [6, 120]);

      expect(await a.product(1).compare(expected, DELTA)).toBeTruthy();
    });
    ...
    it('should work with multiple product axes', async () => {
      ...
      const expected2 = constructor([3], [4.0320000648498535, 12600, 0.02835000306367874]);

      expect(await a.product([0,2]).compare(expected2, DELTA)).toBeTruthy();
    });
  });
  ...
  describe(`${name} max`, () => {
    ...
    it('should compute the column wise max with axes=0', async () => {
      ...
      const expected = constructor([3], [4, 5, 6]);

      expect(await a.max(0).compare(expected, DELTA)).toBeTruthy();
    });
    ...
    it('should compute the row wise max with axes=1', async () => {
      ...
      const expected = constructor([2], [3, 6]);

      expect(await a.max(1).compare(expected, DELTA)).toBeTruthy();
    });
  ...
  describe(`${name} min`, () => {
    ...
    it('should compute the column wise min with axes=0', async () => {
      ...
      const a = constructor([2, 3], [1, 5, 3, 4, 2, 6]);
      const expected = constructor([3], [1, 2, 3]);

      expect(await a.min(0).compare(expected, DELTA)).toBeTruthy();
    });
    ...
    it('should compute the row wise min with axes=1', async () => {
      ...
      const a = constructor([2, 3], [1, 3, 2, 6, 4, 5]);
      const expected = constructor([2], [1, 4]);

      expect(await a.min(1).compare(expected, DELTA)).toBeTruthy();
    });
