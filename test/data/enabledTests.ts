...
export const enabledTests: Test[] = [
  ...
  {name: 'test_argmin_keepdims_example', opsets: ['8', '9', '10', '11', '12']},
  {name: 'test_argmin_keepdims_random', opsets: ['8', '9', '10', '11', '12']},
  {
  ...
  {name: 'test_argmin_default_axis_example_select_last_index', opsets: ['12']},
  {name: 'test_argmin_default_axis_random_select_last_index', opsets: ['12']},
  {name: 'test_argmin_keepdims_example_select_last_index', opsets: ['12']},
  {name: 'test_argmin_keepdims_random_select_last_index', opsets: ['12']},
  {name: 'test_argmin_negative_axis_keepdims_example', opsets: ['12']},
  {
    name: 'test_argmin_negative_axis_keepdims_example_select_last_index',
    opsets: ['12'],
  },
  {name: 'test_argmin_negative_axis_keepdims_random', opsets: ['12']},
  {
    name: 'test_argmin_negative_axis_keepdims_random_select_last_index',
    opsets: ['12'],
  },
  {name: 'test_argmin_no_keepdims_example_select_last_index', opsets: ['12']},
  {name: 'test_argmin_no_keepdims_random_select_last_index', opsets: ['12']},
